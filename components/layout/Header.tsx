          ...
          <>
            ...
            <div className="relative hidden md:block">
              ...
              <input
                ...
                className="pl-9 pr-4 py-2 bg-neutral-50 border border-neutral-200 rounded-xl text-sm text-neutral-700 placeholder:text-neutral-400 focus:outline-none focus:ring-2 focus:ring-rose-400 focus:border-transparent w-52 transition-all"
              />
            </div>
