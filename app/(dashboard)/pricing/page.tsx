    ...
    <div className="space-y-8 max-w-5xl mx-auto">
      ...
      {confirming && (
        <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center">
          ...
          />
          <div className="relative bg-white w-full md:max-w-sm rounded-t-3xl md:rounded-2xl p-6 shadow-elevated">
              ...
              <tr className="border-b border-neutral-100">
                ...
                {PLAN_ORDER.map((id) => (
                  ...
                  >
                    {PLANS[id].name}
                    {id === planId && (
                      <span className="ml-1.5 text-[10px] bg-rose-100 text-rose-600 px-1.5 py-0.5 rounded-full font-semibold normal-case tracking-normal">
                        atual
                      </span>
                    )}
                  </th>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pb-4">
        {[
          ...
          <div
            key={faq.q}
            className="bg-white rounded-2xl border border-neutral-200 shadow-card p-5"
          >
