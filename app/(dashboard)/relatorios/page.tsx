...
import { TrendingUp, Users, ShoppingBag, DollarSign, Lock, ArrowRight } from "lucide-react";
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 px-6 text-center">
      ...
      <p className="text-sm text-neutral-500 max-w-sm mb-6">
        Acesse gráficos de receita, análise por categoria e ranking de melhores clientes para tomar decisões mais inteligentes.
      </p>
      <Link
        href="/pricing"
                ...
                <div className="flex flex-col gap-3 w-full px-4">
                  {categoryRevenue.map((c, i) => (
                    <div key={c.name} className="flex items-center gap-2">
                      <div className="w-2.5 h-2.5 rounded-full" style={{ background: ROSE_PALETTE[i] }} />
      ...
      <Card>
        ...
        <div className="space-y-3">
          {mockClients
            ...
            .slice(0, 5)
            .map((client, i) => {
              const maxSpent = mockClients.slice().sort((a, b) => b.total_spent - a.total_spent)[0].total_spent;
              return (
        ...
        <Card className="border-dashed border-neutral-300">
          <div className="flex flex-col sm:flex-row items-center gap-4 py-2">
            ...
            <div className="flex-1 text-center sm:text-left">
              <p className="text-sm font-semibold text-neutral-700">Relatórios avançados no Premium</p>
            ...
            <Link
              href="/pricing"
              className="flex-shrink-0 inline-flex items-center gap-1.5 px-4 py-2 bg-neutral-900 text-white rounded-xl text-xs font-semibold hover:bg-neutral-700 transition-colors"
            >
